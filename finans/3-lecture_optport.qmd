---
title: "3 - Matrices, Optimal Portfolios and Factors"
author: "Espen Sirnes"
date: "2024-9-18"
pdf-engine: pdflatex
format:
...
where $f(C/B)$ is the portfolio front function `portfolio_front(C/B) at `C/B`
```{python}
# Plotting the portfolio front
...
$$
x - r_f = \alpha + \beta_M (r_M - r_f) + \beta_{SMB} \cdot SMB + \beta_{HML} \cdot HML + \beta_{LIQ} \cdot LIQ + \beta_{MOM} \cdot MOM + \epsilon \tag{18}
$$
